...
const LATEST_WF   = path.join(BASE, 'workflow_FINAL_20260428_intraday_swing_alert_0900.json');
...
const OUTPUT = path.join(BASE, `workflow_FINAL_${ts}_prev_day_surge_filter.json`);
...
console.log('\n코드 변경 내용:');
console.log('  - C-2: MAX_ENTRY_SURGE_PCT=0.10, SURGE_ZONE_PCT=0.08, SURGE_ZONE_MIN_SCORE=270 (line 27-31)');
console.log('  - D-2: 전일대비 10% 초과 절대 차단 + 8%+ 점수 270 미만 차단 (line 1538-1540)');
